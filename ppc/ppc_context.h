...
{
    return simde_mm_add_epi32(a, _mm_min_epu32(simde_mm_xor_si128(a, simde_mm_cmpeq_epi32(a, a)), b));
}
...
inline simde__m128 simde_mm_cvtepu32_ps_(simde__m128i src1)
{
    ...
    return _mm_blendv_ps(xmm2, simde_mm_castsi128_ps(xmm0), simde_mm_castsi128_ps(src1));
}
...
inline simde__m128i simde_mm_perm_epi8_(simde__m128i a, simde__m128i b, simde__m128i c)
{
    ...
    return _mm_blendv_epi8(_mm_shuffle_epi8(a, e), _mm_shuffle_epi8(b, e), simde_mm_slli_epi32(c, 3));
}
...
inline simde__m128i simde_mm_vctsxs(simde__m128 src1)
{
    ...
    simde__m128 dest = _mm_blendv_ps(simde_mm_castsi128_ps(xmm0), simde_mm_castsi128_ps(simde_mm_set1_epi32(INT_MAX)), simde_mm_castsi128_ps(xmm1));
...
inline simde__m128i simde_mm_vsr(simde__m128i a, simde__m128i b)
{
    ...
    return simde_mm_castps_si128(_mm_insert_ps(simde_mm_castsi128_ps(simde_mm_srl_epi64(a, b)), simde_mm_castsi128_ps(simde_mm_srl_epi64(simde_mm_srli_si128(a, 4), b)), 0x10));
}
