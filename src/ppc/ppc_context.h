...
// Provide fallbacks for compiler builtins when not available.
...
/* clang/host provides __builtin_assume */
#else
...
#define __builtin_rotateleft32(x, n) (uint32_t)((((uint32_t)(x)) << ((n) & 31)) | (((uint32_t)(x)) >> ((32 - ((n) & 31)) & 31)))
#endif

#ifndef __builtin_rotateleft64
#define __builtin_rotateleft64(x, n) (uint64_t)((((uint64_t)(x)) << ((n) & 63)) | (((uint64_t)(x)) >> ((64 - ((n) & 63)) & 63)))
#endif
...
namespace simd {
    inline void store_shuffled(PPCVRegister& dst, vec128i v, const uint8_t* mask) {
        store_shuffled(dst.u8, v, mask);
    }

    inline void store_shuffled(PPCVRegister& dst, const uint8_t* base, const uint8_t* mask) {
        store_shuffled(dst.u8, base, mask);
    }

    inline void store_shuffled(PPCVRegister& dst, vec128i v) {
        store_shuffled(dst.u8, v);
    }
} // namespace simd
