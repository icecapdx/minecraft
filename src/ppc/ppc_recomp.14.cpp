...
PPC_FUNC_IMPL(__imp__sub_820C5EA8) {
	...
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820C5F98;
	// bdzf 4*cr6+eq,0x820c5fa0
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820C5FA0;
	// bdzf 4*cr6+eq,0x820c5fa8
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820C5FA8;
	// bdzf 4*cr6+eq,0x820c6294
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820C6294;
	// bdzf 4*cr6+eq,0x820c5fb4
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820C5FB4;
	// bdzf 4*cr6+eq,0x820c5fc4
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820C5FC4;
	// bne cr6,0x820c5fd4
...
PPC_FUNC_IMPL(__imp__sub_820CA0F0) {
	...
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820CA138;
	// bdzf 4*cr6+eq,0x820ca148
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820CA148;
	// bdzf 4*cr6+eq,0x820ca154
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820CA154;
	// bdzf 4*cr6+eq,0x820ca160
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820CA160;
	// bdzf 4*cr6+eq,0x820ca16c
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820CA16C;
	// bdzf 4*cr6+eq,0x820ca17c
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820CA17C;
	// bne cr6,0x820ca18c
