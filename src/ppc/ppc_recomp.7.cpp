...
PPC_FUNC_IMPL(__imp__sub_82088660) {
	...
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820886C4;
	// bdzf 4*cr6+eq,0x820886d8
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820886D8;
	// bdzf 4*cr6+eq,0x820886ec
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820886EC;
	// bdzf 4*cr6+eq,0x82088718
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_82088718;
	// bdzf 4*cr6+eq,0x82088704
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_82088704;
	// bdzf 4*cr6+eq,0x8208872c
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_8208872C;
	// bdzf 4*cr6+eq,0x8208873c
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_8208873C;
	// bne cr6,0x8208874c
...
PPC_FUNC_IMPL(__imp__sub_82088780) {
	...
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820887E0;
	// bdzf 4*cr6+eq,0x820887e0
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820887E0;
	// bdzf 4*cr6+eq,0x820887e8
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820887E8;
	// bdzf 4*cr6+eq,0x820887f8
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820887F8;
	// bdzf 4*cr6+eq,0x820887f0
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820887F0;
	// bdzf 4*cr6+eq,0x82088810
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_82088810;
	// bdzf 4*cr6+eq,0x82088818
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_82088818;
	// bne cr6,0x82088820
...
loc_82088978:
	...
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820889E4;
	// bdzf 4*cr6+eq,0x820889fc
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820889FC;
	// bdzf 4*cr6+eq,0x82088a18
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_82088A18;
	// bdzf 4*cr6+eq,0x82088b10
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_82088B10;
	// bdzf 4*cr6+eq,0x82088a3c
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_82088A3C;
	// bdzf 4*cr6+eq,0x82088b28
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_82088B28;
	// bne cr6,0x82088b64
