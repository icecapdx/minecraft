...
loc_82055D88:
	...
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_82055DE8;
	// bdzf 4*cr6+eq,0x82055de8
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_82055DE8;
	// bdzf 4*cr6+eq,0x82055df0
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_82055DF0;
	// bdzf 4*cr6+eq,0x82055dfc
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_82055DFC;
	// bdzf 4*cr6+eq,0x82055de8
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_82055DE8;
	// bdzf 4*cr6+eq,0x82055e08
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_82055E08;
	// bne cr6,0x82055e24
...
PPC_FUNC_IMPL(__imp__sub_820561D8) {
	...
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_82056294;
	// bdzf 4*cr6+eq,0x820562c0
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820562C0;
	// bdzf 4*cr6+eq,0x820562ec
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820562EC;
	// bdzf 4*cr6+eq,0x82056318
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_82056318;
	// bdzf 4*cr6+eq,0x8205632c
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_8205632C;
	// bdzf 4*cr6+eq,0x82056358
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_82056358;
	// bne cr6,0x8205638c
...
PPC_FUNC_IMPL(__imp__sub_820563F0) {
	...
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_8205647C;
	// bdzf 4*cr6+eq,0x82056498
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_82056498;
	// bdzf 4*cr6+eq,0x820564b0
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820564B0;
	// bdzf 4*cr6+eq,0x820564d0
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_820564D0;
	// bdzf 4*cr6+eq,0x82056540
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_82056540;
	// bdzf 4*cr6+eq,0x82056558
	--ctx.ctr.u64;
	if (ctx.ctr.u32 == 0 && !ctx.cr6.eq) goto loc_82056558;
	// bne cr6,0x8205658c
