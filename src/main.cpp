// minecraft - ReXGlue Recompiled Project
// Generated by: rexglue init

#include <stdio.h>
#include <wchar.h>
#include "generated/minecraft_config.h"
#include "generated/minecraft_init.h"
...
class MinecraftApp : public rex::ui::WindowedApp, public rex::ui::WindowListener {
public:
    static std::unique_ptr<rex::ui::WindowedApp> Create(rex::ui::WindowedAppContext& ctx) {
        return std::make_unique<MinecraftApp>(ctx);
    }

    MinecraftApp(rex::ui::WindowedAppContext& ctx)
        : WindowedApp(ctx, "minecraft", "[game_directory]") {
    ...
    bool OnInitialize() override {
        ...
        REXLOG_INFO("minecraft starting");
        ...
        // Create window
        window_ = rex::ui::Window::Create(app_context(), "minecraft", 1280, 720);
        if (!window_) {
...
XE_DEFINE_WINDOWED_APP(minecraft, MinecraftApp::Create)

#define STUB_KERNEL(x) __attribute__((alias("__imp__" #x))) PPC_FUNC(x); \
PPC_FUNC_IMPL(__imp__##x) { std::cout << __FUNCTION__ << " stub!"; return; }

STUB_KERNEL(XeCryptRotSumSha)
STUB_KERNEL(XeKeysGetKey)
STUB_KERNEL(XeCryptBnQwBeSigVerify)